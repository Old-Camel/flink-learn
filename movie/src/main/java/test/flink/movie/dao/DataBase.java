package test.flink.movie.dao;

import test.flink.movie.bean.MovieBean;
import test.flink.movie.bean.RatingBean;
import test.flink.movie.util.Dataset;
import test.flink.movie.util.MovieDataset;

import java.sql.*;

public class DataBase {
    public static final String DRIVER = "com.mysql.jdbc.Driver";
    public static final String URL = "jdbc:mysql://222.30.195.177:4000/movie?characterEncoding=UTF-8";
    public static final String USR = "root";
    public static final String PSW = "111111";
